...
class App extends React.Component<any, any> {
  ...
  async init() {
    ...
    if (body) {
      ...
      const resourceType =
        body.resourceType || findByResourceId(resourceId)?.name || "";
  ...
  private loadSettings = () => {
    ...
    if ((window as any).AP) {
      // eslint-disable-next-line no-undef
      (window as any).AP.request(
        "/rest/atlassian-connect/1/addons/com.aws.widget.confluence-addon/properties/aws-credentials?jsonValue=true",
        {
